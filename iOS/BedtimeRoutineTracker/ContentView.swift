...
struct ContentView: View {
    ...
    @State private var editingItem: RoutineStep?
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle("Bedtime Routine Tracker")
            .toolbar {
...
struct EditItemView: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle(item == nil ? "Add Routine Step" : "Edit Routine Step")
            .toolbar {
                ...
                ToolbarItem(placement: .confirmationAction) {
                    Button("Save") {
                        var new = item ?? RoutineStep(title: "", note: "")
                        new.title = field1
                        new.note = field2
                        onSave(new)
                        dismiss()
